      ...
      <a class="navbar-brand" href="index.php"><img src="view/ImagesOther/logo_mobileviet.jpg" alt="logo" width="160px" /></a>
       <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mx-auto">
         <li class="nav-item"><a class="nav-link" href="index.php"><i class="bi bi-house"></i> Trang chủ</a></li>
          <li class="nav-item dropdown"><a class="nav-link" href="#"><i class="bi bi-phone"></i> Sản phẩm</a>            
            <ul class="dropdown-menu">
              ...
              <?php
                if(isset($_SESSION['username'])&&($_SESSION['username']!="")){
                  echo ' <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-person"></i> '.$_SESSION['username'].'</a></li>';
                  echo ' <li class="nav-item"><a class="nav-link" href="index.php?act=thoat"><i class="bi bi-box-arrow-left"></i> Đăng xuất</a></li>';
                }else{
              ?>
              <li class="nav-item"><a class="nav-link" href="admin/login.php"><i class="bi bi-box-arrow-right"></i>  Đăng nhập</a></li>
              <?php
                }
                ?>
